    $(function() {
	    ...
	    function showTooltip(){
		    ...
		    if(e_t < b_t)
			    b_t = e_t; // b_t is the min top value between element.top and tooltip.top
		    
                    var b_b = parseFloat(properties.top,10) + $tooltip.height();

		    if((e_t + e_h) > b_b)
			    b_b = e_t + e_h; // b_b is the max value between (element.top + element.height) and (tooltip.top + tooltip.height)
